                  ...
                  <div className="hidden sm:flex items-center justify-between px-4 py-3.5 gap-4 w-full">
                      ...
                      <div className='flex flex-col items-start w-full'>
                        ...
                        <div className="flex items-center gap-1.5 mt-3.25">
                          <div className="relative w-8.25 h-0.5 bg-[#DFEBFC] rounded-2xl">
                            <div className="absolute left-0 top-0 w-4.25 h-0.5 bg-[#3385FF] rounded-2xl" />
                          </div>
                          {row.payment === "detail" && (
                    ...
                    <div className='w-full flex items-start justify-start'>
                      <div className="flex items-center gap-4 text-right justify-end w-full">
                        <div>
                          <p
                            className={`font-lexend font-medium text-[11px] sm:text-[12.04px] md:text-[13px] lg:text-[14px] leading-none ${row.cancelled ? "text-[#FF284C]" : "text-[#272742]"
                              }`}
                          >
                            {row.status}
                          </p>
                          <p
                            className={`font-lexend text-[9px] sm:text-[10.03px] md:text-[11px] lg:text-[12px] line-through mt-1.5 ${row.cancelled ? "text-[#FF284C]" : "text-[#5096FF]"
                              }`}
                          >
                            {row.score}
                          </p>
